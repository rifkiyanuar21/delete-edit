...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="container mt-4">
        <h2>Data Siswa</h2><br>
        <a class="btn btn-primary" href="kelola.php" role="button">Kelola Data</a>
        <br><br>
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)) {
                   ...
                   echo "<td>"; 
                    ...
                    echo "<a href='kelola.php?edit=" . $siswa['id_pendaftaran'] . "' class='btn btn-info'>Edit</a>";
                  echo  " <a href='proses.php?hapus=" . $siswa['id_pendaftaran'] . "' class='btn btn-primary'>Delete</a>";
                        echo  "</td>";
                    echo "</tr>";
                }
                ?>
